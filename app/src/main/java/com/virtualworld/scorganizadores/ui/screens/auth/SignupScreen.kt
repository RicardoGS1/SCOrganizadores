...
import com.virtualworld.scorganizadores.ui.screens.auth.viewModels.SignUpViewModel
...
fun SignUpRoute(
    ...
    val signUpState by viewModel.signUp.observeAsState(initial = ScreenStateUser.Loading)

    val onCreateAccountButtonClicked = { user: UserInformationEntity ->
