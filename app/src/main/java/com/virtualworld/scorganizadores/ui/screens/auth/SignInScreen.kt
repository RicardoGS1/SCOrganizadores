package com.virtualworld.scorganizadores.ui.screens.auth
...
import com.virtualworld.scorganizadores.ui.screens.auth.viewModels.SigInViewModel
...
fun SignInRoute(
    ...
    val firebaseLoginState by viewModel.firebaseLoginState.observeAsState(initial = ScreenStateUser.Loading)
